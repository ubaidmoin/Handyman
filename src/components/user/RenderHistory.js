...
import { Text, View, StyleSheet, ImageBackground, KeyboardAvoidingView, TouchableOpacity,  Image } from 'react-native';
                        ...
                        <View style={styles.detailContainer}>
                          <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                            ...
                            <Icon                   
                              ...
                              color='grey'                 
                              />
                              <Text style={{color:'grey', fontWeight: 'bold', fontSize:15, marginLeft:3}} onPress={() => navigation.navigate('ReportProblem')}>Report a problem</Text>
                              </TouchableOpacity>                                                                                                          
                        </View>                                       
                    </CardSection>
                  </TouchableOpacity>
