...
class SearchHandyman extends Component {
  ...
  onSearchClick = () => {
    let url =
      "http://192.168.1.115/HandymanAPI/api/getAvailableHandyman?category=" +
      this.state.category;
    fetch(url, {
      method: "GET",
      headers: {
    ...
    this.setState({
      availableHandyman: [
        ...
        },
        {
          ...
          rating: "4.5",
          category: "Electrician",
          coords: { latitude: 33.6298, longitude: 73.042 }
        },
        {
          name: "Anees",
          mobileno: "03325426789",
          rating: "5",
          category: "Electrician",
          coords: { latitude: 33.66, longitude: 73.0833 }
        },
        {
          name: "Basit",
          mobileno: "03325426789",
  ...
  renderElements() {
    return this.state.availableHandyman
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Dialog.Container visible={this.state.dialogVisible}>
            ...
            <Dialog.Description>Do you want to book him?</Dialog.Description>
