      ...
      <TouchableOpacity onPress={() => onClickListener(name)}>
        <View style={styles.cardSectionStyle}>
          <View style={{ flexDirection: "column", marginLeft: 40 }}>
            {name === "Electrician" ? (
              <Image
                source={require("../assets/electricianLogo.jpg")}
                style={styles.displayPicStyle}
              />
            ) : name === "Plumber" ? (
              <Image
                source={require("../assets/plumberLogo.jpg")}
                style={styles.displayPicStyle}
              />
            ) : name === "Carpenter" ? (
              <Image
                source={require("../assets/carpenterLogo.jpg")}
                style={styles.displayPicStyle}
              />
            ) : name === "Beautician" ? (
              <Image
                source={require("../assets/beauticianLogo.png")}
                style={styles.displayPicStyle}
              />
            ) : name === "Mechanic" ? (
              <Image
                source={require("../assets/mechanicLogo.png")}
                style={styles.displayPicStyle}
              />
            ) : name === "Painter" ? (
              <Image
