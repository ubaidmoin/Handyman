...
import { Text, View, StyleSheet, ImageBackground, KeyboardAvoidingView, TouchableOpacity, Icon } from 'react-native';
...
class LoginScreen extends Component {
  ...
  onButtonPress() {
    let url = 'http://192.168.1.116/HandymanAPI/api/login?email='+this.state.email+'&password='+this.state.password
    /*fetch(url, {
            method: 'GET',
        headers: {
