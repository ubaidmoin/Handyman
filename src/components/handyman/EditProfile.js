...
class EditProfile extends Component {
  ...
  onButtonPress() {
    let data = []
    let url = 'http://' + global.ip + '/HandymanAPI/api/editHandymanProfile'
    data = {
  ...
  async componentDidMount(){
    ...
    this.setState({
      name: this.state.handymanData.name,
      contact: this.state.handymanData.contact,
      dob: this.state.handymanData.dob,
      profileImage: this.state.handymanData.image
    })
  }
