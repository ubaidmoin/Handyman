  ...
  render() {
    return (
      <View style={{ width: "100%", height: "100%" }}>
        <MapView style={styles.mapStyle} region={this.state.origin}>
          <Marker
        ...
        >
          <View style={{ height: 350, flexDirection: "column" }}>
            <View style={{ height: "15%", flexDirection: "row" }}>
              <Text
                style={{ fontSize: 20, fontWeight: "bold", marginLeft: 25 }}
              >
                Select Provided Services
              </Text>
            </View>
            <View style={{ height: "121%", marginTop: "5%" }}>
              <ScrollView>{this.renderService()}</ScrollView>
              <TouchableOpacity
                style={{
                  position: "absolute",
                  bottom: 0,
